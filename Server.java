...
//		con.setRequestProperty("User-Agent", "Mozilla/5.0");
		...
		User obj_Profile_Bean = new User();
...
//		obj_Profile_Bean.setEmail(myResponse.getString("email"));
	...
	public static void main(String[] args) {
		...
		try {
			User profile_Bean = profile_Modal.call_me("EAAGEg1f2olMBAP1DkERDwGCQIZA43vB7Pe0VsOBZCE34PuSrByB5L6UrkjsA7hPjJPIZAdKwnFPEcrYP2neDBSkuid8niM1OdjVZBUNy0lAZBE9hQkUaRZBlUtpZAmNfegqSQhhZCab2dDJR08l85Ow7yqDyDTubuZC74kmRyzYY6rKTeUfUBnCZABvIfxNJecDTkLwuZCnJ5GizwZDZD");
